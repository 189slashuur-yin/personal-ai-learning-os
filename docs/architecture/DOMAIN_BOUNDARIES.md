...
| Task (planned) | Action text, TaskType, open/completed state, optional scheduled date, Workspace placement, optional SourceRef. | Knowledge content, source lifecycle, Calendar events, reminders, automation, or autonomous execution. |
