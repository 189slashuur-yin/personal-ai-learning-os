...
- Next Recommended Phase：v1.0 planning（先完成 v0.9 人工 QA）
...
架构图与决策记录见 [Architecture Diagram](./docs/architecture/architecture-diagram.md)、[RFC-004](./docs/rfc/RFC-004-data-and-search-foundation.md)、[ADR-001](./docs/adr/ADR-001-localstorage-first.md)、[ADR-002](./docs/adr/ADR-002-human-review-required.md) 与 [ADR-003](./docs/adr/ADR-003-local-asset-library.md)。
