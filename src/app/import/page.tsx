...
export default function ImportPage() {
  return (
    <main className="page-shell">
      ...
      <p className="page-description">粘贴对话、导入 ChatGPT Export（conversations.json）或手动整理轮次；预览后再确认写入本地。ChatGPT 用户请在设置中导出数据 → 下载 zip → 解压找到 conversations.json → 选择「导入 ChatGPT Export」。</p>
