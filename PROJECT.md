...
截至 2026-07-03，Sprint1–Sprint11 已完成。项目已经从单次 TXT 导入流程演进为可在浏览器中运行的个人知识工作区，并增加面向 ChatGPT、Claude、DeepSeek、Gemini 与普通文本的 Clipboard Import 预处理，以及可选的本地 Ollama Analyzer。
