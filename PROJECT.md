...
截至 2026-07-05，当前版本为 v0.9 draft — Data Foundation & Search。项目已在既有知识主链路上增加九类运行时 SearchDocument、具体 Message / Q&A / Proposal / Knowledge 片段定位、轻量 subsequence fuzzy、Conversation Note、Asset metadata foundation、手动备份脚本与 Data Management 说明。
