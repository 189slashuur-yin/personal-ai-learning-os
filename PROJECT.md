...
截至 2026-07-04，Sprint1–Sprint11、Epic A、Epic B、Epic C Search 2.0 与 Epic D 已完成，当前版本为 v0.7 Daily Learning Workflow。项目已经从单次 TXT 导入流程演进为可在浏览器中运行的个人知识与日常行动工作区，并增加 Clipboard Import 预处理、六类实体结构化本地搜索、Task Domain、Today、Source-linked Task，以及可选的本地 Ollama Analyzer。
