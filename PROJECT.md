...
截至 2026-07-02，Sprint1–Sprint7 已完成。项目已经从单次 TXT 导入流程演进为可在浏览器中运行的个人知识工作区，包含 Conversation、Message、Proposal、KnowledgeCard、Tag、AIProvider、AnalyzerPromptTemplate 和 AnalyzerRun 领域模型。
